  ...
  return (
    <div className='w-full h-[100px] bg-[#5c07B7] mb-8 flex justify-between'>
      ...
      <div className='my-auto pr-24'>
        <button className='w-[120px] h-[37px] bg-transparent border-[1.9px] border-white rounded-3xl text-white font-normal text-[14px]'>Contact Us <FontAwesomeIcon className='-rotate-45' icon={faArrowRightLong} /></button>
      </div>
    </div>
  )
}
