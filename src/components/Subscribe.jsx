...
const Subscribe = () => {
  return (
    <div className="w-full h-[300px] bg-gray-100 pt-8 mt-24">
        <h2 className='text-center text-[55px] font-bold text-[#5c07B7]'>Subscribe to our Newsletter.</h2>
        <p className='text-center mx-auto w-[60%] text-[20px] font-semibold'>Get updates and tips from us right into your inbox. <FontAwesomeIcon className='-rotate-45' icon={faArrowRightLong} /></p>
