  ...
  return (
    <div className='w-full flex justify-center mt-20 gap-4'>
        <div className='w-[45%] h-[400px]'>
            <img src={'/src/assets/about.png'} alt="" className='w-auto h-auto '/>
        </div>
        <div className='w-[45%] my-auto'>
            <h5 className='text-gray-600 text-[20px] font-semibold'>Who we are</h5>
            <h1 className='text-[30px] font-semibold'>Get to know aboutsq <span className='text-[#5c07B7]'>Splittas <br /> Technology.</span></h1>
            ...
            <button className='w-[120px] h-[37px] bg-[#5c07B7] rounded-3xl text-white font-semibold text-[14px] mt-8'>Read more <FontAwesomeIcon className='-rotate-45' icon={faArrowRightLong} /></button>
        </div>
    </div>
  )
}
