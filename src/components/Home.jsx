    ...
    {/* Hero */}
        ...
        <section className='w-full flex flex-col lg:flex-row justify-between mt-24'>
            <div className='w-[100%] lg:w-[50%] pl-6 md:pl-14 pt-8'>
                <h1 className='text-[45px] lg:text-[65px] font-extrabold text-center lg:text-left'>Split the<span className='text-[#5c07B7]'> Stress, </span><br /> Not just the <span className='text-[#5c07B7]'> Bills. </span></h1>
