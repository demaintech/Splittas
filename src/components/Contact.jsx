...
const Contact = () => {
  return (
    <div className='w-full pb-12 mt-12'>
        <h1 className='text-center text-[55px] font-bold text-[#5c07B7]'>Get in touch with us.</h1>
        <p className='text-center mx-auto w-[60%] text-[20px] font-semibold'>Got anything to tell us? We'll be glad to hear from you.</p>
        <div className='flex w-full justify-between'>
            <div className='w-[50%] flex flex-col pl-16 pt-24'>
