...
const Contact = () => {
  return (
    <motion.div 
        className='w-[95%] mx-auto rounded-3xl  mt-12  contactImg text-white h-[820px] lg:h-[620px]'
        initial={{ opacity: 0, y: 200 }}           // Start 40px lower and invisible
        whileInView={{ opacity: 1, y: 0 }}        // Animate to visible and y=0
        viewport={{ once: false }}
        transition={{ duration: 1 }}
        >
        <div className="bg-black bg-opacity-60 w-[100%] h-[100%] py-8 rounded-3xl flex flex-row justify-between">
        <div></div>
        <div className="flex flex-col text-center w-[60%] justify-center items-center gap-8">
